...
/*
 * Definição dos tipos LL_t e S64 por conveniência.
 */
 ...
 * Retorno:
 * - Ponteiro (LL_t *) para a nova lista.
 ...
 * Argumentos:
 * 1. Ponteiro (LL_t *) para a lista a ser impressa.
 ...
 * Argumentos:
 * 1. Ponteiro para o ponteiro (LL_t **) para a lista a ser destruida.
 ...
 * 2. Ponteiro (LL_t *) para a lista na qual o item sera adicionado.
 ...
 * 3. Ponteiro (LL_t *) para a lista na qual o item sera adicionado.
 ...
 * 2. Ponteiro (LL_t *) para a lista onde se deseja procurar.
 * 3. Ponteiro para função (bool) que compara os itens.
 *   Argumentos:
 *   1. Ponteiro (void *) do primeiro item.
 *   2. Ponteiro (void *) do segundo item.
 ...
 * 2. Ponteiro (LL_t *) para a lista de que se deseja o item.
 * Retorno:
 ...
 * 2. Ponteiro (LL_t *) para a lista de onde se deseja remover.
 ...
 * 2. Ponteiro (LL_t *) para a lista de que se deseja remover.
 * Retorno:
 ...
 * Argumentos:
 * 1. Ponteiro (LL_t *) para a lista de qual se deseja o tamanho.
 * Retorno:
 ...
 * Argumentos:
 * 1. Ponteiro (LL_t *) para a lista que se deseja saber se está vazia.
 * Retorno:
